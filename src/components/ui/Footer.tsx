...
const Footer = () => {
  return (
    <AntFooter
      ...
      className=" px-6 mx-auto space-y-6 divide-y  divide-gray-400 md:space-y-12 bg-gray-200"
    >
      <div className=" px-6 mx-auto  divide-y divide-gray-800 md:space-y-12 divide-opacity-50">
        <div className="grid lg:grid-cols-3 grid-cols-1 gap-4">
          <div>
            ...
            <p className=" text-base mt-5">
              ...
              Distinctio libero fuga earum magnam rerum ea illum delectus! Eos,
              quaerat eius!
            </p>
          </div>
          <div>
